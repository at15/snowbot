...
We use Cornell Movie Dialog Corpus~\cite{data:cornell} because it is used by many publication and blog posts for single turn dialog system.
It contains 83097 conversations, and can be converted to 221282 single turn QA.

\subsection{Handling I don't know}
\label{subsec:idk}

Our first run using sockeye shows \verb+I don't know+ is the most popular response,
