...
For many to many RNN + LSTM (seq2seq), simply swap the input and output data, you get a different application for free,
which is exactly what we did, we use neural machine translation framework to build our chatbot.
